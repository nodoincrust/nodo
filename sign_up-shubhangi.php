...
<!--        <div class="wrapper">-->
	...
	<div class="container form_container well container-narrow div-padding-top">	
		...
		<!-- Form start-->	
               <div class="row">
<!--               <fieldset>-->
		<form id="registrationForm" method="post" class="form-horizontal col-md-12 form-action" action="my_script.php" >
...
<div class="individual">
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                                 <div class="col-md-5">
                                     <select class="form-control" name="user_countrycode">
                                        <option>+91</option>
                                        <option>+92</option>
                                        <option>+93</option>
                                        <option>+94</option>
...
<!--                    <button class="btn btn-success ctrl-btn"><i class="icon-ok-sign icon-white"></i> Save Button</button>
             ...
             <div class="form-group row ">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="txt_package" placeholder="Package Selected" value="" name="" readonly>
                            </div>
            </div>
            <div class="form-group row ">
                            <label for="txt_user_mail" class="col-md-4 control-label">Date of Recharge</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="txt_recharge_date" placeholder="Date of Recharge" value="" name="recharge_date" readonly>
                            </div>
            </div>
            <div class="form-group row ">
                            <label for="txt_user_mail" class="col-md-4 control-label">Package Price</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="txt_package_price" placeholder="Package Price" value="" name="package_price" readonly>
                            </div>
            </div>
            <div class="form-group row ">
                            <label for="txt_user_mail" class="col-md-4  control-label">Taxes</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="txt_taxes" placeholder="Taxes" name="tax" value="" readonly>
                            </div>
            </div>
            <div class="form-group row ">
                            <label for="txt_user_mail" class="col-md-4 control-label">Total amount to be paid</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control add-more" id="txt_total_amount" placeholder="Total Amount to be Paid" name="total_amount" readonly>
                            </div>
            </div>
...
<!--                <input type="submit" value="submit" class="btn btn-success">-->
                <button class="btn btn-primary btn-space" type="submit" name="loginbtn" value="signup">Sign in</button>
