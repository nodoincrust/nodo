         ...
         <div class="col-md-3 span3" style="">
              ...
              <hr/>
                ...
                <div class="col-md-3 span3"> <label class="control-label">Textbox</label><label class="requiredcls">*</label></div>
                    <div class="col-md-9 span9"><input type="text" placeholder="write text here..." class="ctrl-textbox" minlength="" maxlength=""/>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9"><span class="ctrl-text">
                            <textarea name="textarea" rows="4" cols="50" class="ctrl-textbox" minlength="" maxlength=""></textarea>
                            <input type="hidden" class="min_length" value="" />
                            <input type="hidden" class="max_length" value="" />
                        </span></div>
                </div>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9">
                        <span class="expiry-date"><input type="text" name="expirydate" class="expirydate" id="expiry-date" onclick="getCalDate();"/></span>
                        <span class="ctrl-date">{YYYY-MM-DD}</span></div>
                </div>
                </div>
  ...
  <!-- List of controls rendered into Bootstrap Tabs -->
    ...
    <div class="modal-body">
        ...
        <p id="pfonts"><label class="control-label" for="fonts-textbox">Select Font:</label>
                ...
                <span class="fontbox" onclick="change_size('12');">SA</span>
                <span class="fontbox" onclick="change_size('14');">MA</span>
                <span class="fontbox" onclick="change_size('16');">BA</span>
        </p>
    ...
    <div class="modal-footer">
        <button class="btn btn-primary" data-dismiss="modal" onclick='save_customize_changes();apply_font();'>Save Changes</button>
    ...
    <p id="plength">
        <label class="control-label">Length limit</label>
                ...
                <!--<select name="minmax_lenlimit" class="length_base">
                    <option value="characters">characters</option>
                    <option value="words">words</options>
                </select>-->    
        </p>
    </script>
...
<!--<label class="control-label" for="handlebars-textbox-text">Textarea</label> <textarea name="texte" rows="10"  id="handlebars-textbox-text"></textarea>--></p>  
<!--    <p><label class="control-label" for="handlebars-textbox-text"></p>Textbox</label><input type="text" name="txt_label" id="handlebars-textbox-text" value="" /></p>    -->
    </script>
