    ...
    <div class="row row-fluid">
         ...
         <div class="col-md-3 span3" style="">
              ...
              <hr/>
                ...
                <div class='modele'>
                    <label class="col-md-12 span12 control-label forms_lbl ctrl-multilabel">Multi-line Label:</label>
                    <input type="hidden" value="" class="label_font"/>
                    <input type="hidden" value="" class="label_id">
                    <input type="hidden" value="" class="label_size">
                </div>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9"><span class="ctrl-text">
                            <textarea class="cntrol_comp" name="textarea" rows="4" cols="50" class="ctrl-textbox" minlength="" maxlength="" onkeyup="display_minmaxlen_err(this)" /></textarea><span class="textbox_err_msg"></span>
                            <p class="required_msg"></p>
                            <input type="hidden" class="hiddenObligatoire"/>
                            <input type="hidden" class="min_length" value="" />
                            <input type="hidden" class="max_length" value="" />
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9"><input class="ctrl-passwordbox cntrol_comp" type="password" placeholder="Enter Password" />
                        <p class="required_msg"></p>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9"><select class="ctrl-combobox cntrol_comp">
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label">Date</label><label class="label_req requiredcls">*</label></div>
                    <div class="col-md-9 span9">
                        <span class="ctrl-date"><input class="cntrol_comp" type="text" name="expirydate" class="expirydate" id="expiry-date" onclick="display_expiryCal();" /></span>
                    </div>
                    <p class="required_msg"></p>
                </div>
                </div>
                ...
                <div class='selectorField draggableField'>
                    ...
                    <div class="modele">
                        <div class="col-md-12 span12">
							...
							<input type="hidden" class="addstatus" value="">
                            </div>
                            <div class="row row-fluid col-md-12 span12">
<!--                                <button class="btn tbl_btn" id="add_btn" onclick="add_rowToTable()">Add Row</button>-->
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><div class="row"><label class="control-label label_req"> Std. list</label><label class="label_req requiredcls">*</label></div></div>
                    <div class="col-md-9 span9"><select class="ctrl-stdcombobox cntrol_comp">
<!--                    <option value="option1">Option 1</option>
                    <option value="option2">Option 2</option>
                    <option value="option3">Option 3</option>-->
                    </select>
...
<!--        <p><label class="control-label" for="handlebars-textbox-name">Name</label> <input type="text" value="" name="name" id="handlebars-textbox-name"/></p>-->
	...
	<script id="multilabel-template" type="text/x-handlebars-template">
        <p id="pLibelle"><label class="control-label" for="handlebars-textbox-label">Multiline Label</label> <textarea rows="3" cols="60" name="multilinelabel" value="" id="handlebars-textbox-label"></textarea></p>
        <p id="pObligatoire"><label class="control-label" for="checkbox-obligatoire-textbox">Required</label> <input type="checkbox" name="obligatoire" value="" id="checkbox-obligatoire-textbox"/></p>
        <p id="phelp"><label class="control-label" for="help-textbox">Help</label><textarea value="" name="help" id="handlebars-textbox-help" cols="60"></textarea></p>
        <p id="pfonts"><label class="control-label" for="fonts-textbox">Select Font:</label>
                <span class="fontbox" onclick="change_font('bold');"><i class="fa fa-bold"></i></span>
...
<!--        <p id="pObligatoire"><label class="control-label" for="checkbox-obligatoire-textbox">Required</label> <input type="checkbox" name="obligatoire" value="" id="checkbox-obligatoire-textbox"/></p>
        <p id="phelp"><label class="control-label" for="help-textbox">Help</label><textarea value="" name="help" id="handlebars-textbox-help" cols="60"></textarea></p>
        <p><label class="control-label">Options</label> <textarea name="options" rows="5"></textarea></p>-->
        <p id="std_seletedlist"><label class="control-label">Options</labels><span ><textarea name="options" rows="5" readonly></textarea></span></p>
    </script>
