    ...
    <div class="row row-fluid">
         ...
         <div class="col-md-3 span3" style="">
              ...
              <hr/>
                ...
                <div class='modele'>
                    <div class="col-md-11 span11"><label class="control-label forms_lbl">Label:</label></div>
                ...
                <div class='modele'>
                    <label class="col-md-11 span12 control-label forms_lbl ctrl-label">Multi-line Label:</label>
<!--                    <div class="col-md-1 span1"><input type="hidden" placeholder="write title here..." class="ctrl-label"/></div>-->
                </div>
                </div>
                ...
                <div class='modele'>
                <div class="col-md-3 span3"> <label class="control-label">Textbox</label><label class="requiredcls">*</label></div>
                    <div class="col-md-9 span9"><input type="text" placeholder="write text here..." class="ctrl-textbox"/>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label">Textarea</label></div>
                    <div class="col-md-9 span9"><span class="ctrl-text"><textarea name="textarea" rows="4" cols="50"></textarea></span></div>
                </div>
                </div>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label">Password</label><label class="requiredcls">*</label></div>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label"> Drop-down list</label><label class="requiredcls">*</label></div>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label" style="vertical-align:top">Radio buttons</label><label class="requiredcls">*</label></div>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label" style="vertical-align:top">Multiple Checkbox</label><label class="requiredcls">*</label></div>
                ...
                <div class='modele'>
                    <div class="col-md-3 span3"><label class="control-label" style="vertical-align:top">Selection multiple</label><label class="requiredcls">*</label></div>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9"><span class="expiry-date"><input type="text" name="expirydate" class="expirydate" id="expiry-date" /></span>
                    <span class="ctrl-date">{DD/MM/YYYY}</span></div>
                </div>
                </div>
                ...
                <div class='selectorField draggableField'>
                    ...
                    <div class='modele'>
                        ...
                        <div class="col-md-9 span9"><span class="upload_btn"><input type="file" name="file_up" class="file_up ctrl-label"  disabled = "disabled"/></span>
                        </div>
...
<!--                <div class="selectorField draggableField">
                    <div class="frame well well-mini"><b></b> Frame</div>
                    <div class="modele">
                        <div class="col-md12 span12 framebox"></div>
                    </div>    
                </div>    -->
      ...
      <div class="col-md-9 span9">
        ...
        <div style="border:1px solid #e7e7e7; padding: 25px 5px 5px; float: left; width:100%; z-index:0 !important;">
            ...
            <div class="row row-fluid" id="form-description">
                <input type="text" class="input-large col-md-12 span12" placeholder="Form description" id="form-description" />
            </div>
  ...
  <!-- List of controls rendered into Bootstrap Tabs -->
    ...
    <!--<script type="text/javascript" src="js/tests/vendor/jquery.min.js">-->
...
<!--        <p><label class="control-label" for="handlebars-textbox-name">Name</label> <input type="text" value="" name="name" id="handlebars-textbox-name"/></p>-->
        <p id="phelp"><label class="control-label" for="help-textbox">Help</label><input type="text" value="" name="help" id="handlebars-textbox-help"></p>
    ...
    <script id="labelbox-template" type="text/x-handlebars-template">
    <p><label class="control-label" for="handlebars-textbox-label">Label</label> <input type="text" name="form_label" value=""/></p>  
    </script>
    ...
    <p><!--<label class="control-label" for="handlebars-textbox-text">Textarea</label> <textarea name="texte" rows="10"  id="handlebars-textbox-text"></textarea>--></p>  
    </script>
