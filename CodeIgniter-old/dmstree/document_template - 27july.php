              ...
              <hr/>
                ...
                <div class='modele'>
                    ...
                    <div class="col-md-9 span9">
                        <span class="expiry-date"><input type="text" name="expirydate" class="expirydate" id="expiry-date" onclick="display_expiryCal();"/></span>
<!--                        <span class="ctrl-date">{YYYY-MM-DD}</span>-->
                    </div>
                </div>
                </div>
                ...
                <div class="selectorField draggableField">
                    ...
                    <div class="modele">
                        <div class="col-md12 span12"><div class="image_container control-label">Upload-Image</div></div>
                    </div>    
                </div>    
      ...
      <div class="col-md-9 span9">
        ...
        <div style="border:1px solid #e7e7e7; padding: 25px 5px 5px; float: left; width:100%; z-index:0 !important;">
            <div class="row row-fluid" id="form-title-div">
                <input type="file" placeholder="upload logo image" class="col-md-3 span3" id="form-logo">
                <input type="text" class="input-large col-md-9 span9" placeholder="Type form title here" id="form-title" />
            </div>
...
<!--    <script id="imagebox-template" type="text/x-handlebars-template">
        <p id="pimage">
            <label class="control-label">Select Image:</label>
            <input type="file" name="form_image" class="form_image" value="" />
        </p>
    </script>-->
