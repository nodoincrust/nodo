...
//                        dialogContent+='<script type="text/javascript" src="//code.jquery.com/ui/1.10.4/jquery-ui.js">'+scrpt;
                        ...
                        dialogContent+='<script type="text/javascript" src="js/dmstree_js/document_template_validation.js">'+scrpt;
//                        dialogContent+='<script>'+ $(document).ready(function(){ $( "#expiry-date" ).datepicker({ dateFormat: "yy-mm-dd" }); }); +scrpt;
                        dialogContent+= '</head>\n<body id="temp_body">';
...
//                    window.template.imagebox  = Handlebars.compile($("#imagebox-template").html());
                }
