...
//                        dialogContent+= '<link rel="stylesheet" href="jqueryui/themes/base/jquery-ui.css" />';
                        dialogContent+= '<link  rel="stylesheet" href="bootstrap/css/bootstrap.min.css" media="screen">\n';
                        dialogContent+='<script src="//code.jquery.com/jquery-1.9.1.js">'+scrpt;
//                        dialogContent+='<script type="text/javascript" src="bootstrap/js/jquery.js">'+scrpt;
                        ...
                        dialogContent+='<script type="text/javascript" src="js/dmstree_js/document_template_valid.js">'+scrpt;
                         dialogContent+='<style>\n'+$("#content-styles").html()+'\n</style>\n';
                        dialogContent+= '</head>\n<body id="temp_body">';
