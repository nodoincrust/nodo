        ...
        */
        ...
        function preview() {
                ...
                selected_content.find("div").each(function(i,o) {
                        ...
                        dialogContent+='<input type="button" class="btn" value="Cancel" onclick="#">';
                        dialogContent+='<input type="button" class="btn btn-danger" value="Clear" onclick="#">'; //<i class="icon-trash icon-white"></i>
                        ...
                        dialogContent+='<p>The fields with <span class="manditory_fields"> * </span>are required/mandatory fields.</p>'
                        dialogContent+='</div>';
                        dialogContent+= '\n</body></html>';
...
//                                listvalues +='<textarea name="options" rows="5">';
                                for(var i = 0; i < listlen; i++)
                                    {
//                                        listvalues +='<option value="'+listitem[i]+'">'+listitem[i]+'</option>'
                                           listvalues += listitem[i]+'\n';
                                           $('#std_seletedlist').find('textarea').val(listvalues);
                                    }
//                                listvalues+='</textarea>';
//                                alert(listvalues);
//                                $('#std_seletedlist').remove('textarea');
//                                $('#std_seletedlist').append(listvalues);
//                                formobj.find('#slist').html('');
//                                formobj.find('#slist').html(listvalues);
                            }
    });
}