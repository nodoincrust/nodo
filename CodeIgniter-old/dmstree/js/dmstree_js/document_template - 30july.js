        ...
        */
        ...
        function preview() {
                ...
                selected_content.find("div").each(function(i,o) {
                        ...
                        dialogContent+='<i class="icon-trash icon-white"></i><input type="button" class="btn btn-danger" value="Clear" onclick="#">';
                        dialogContent+='<i class="icon-ok-sign icon-white"></i><input type="button" class="btn btn-success" value="Submit" onclick="#">';
                        dialogContent+='</div>';
