                ...
                <div class='selectorField draggableField'>
                    ...
                    <div class="modele">
                        <div class="col-md-12 span12">
                            <label class="control-label" >Table Parameters:</label>
                            <table class="control-label ctrl-table">
                            </table>    
                        </div>
                    </div>
                </div>    
...
<!--        <p id="ptable"> <label class="control-label" for="form-textbox">Table Parameters:</label></p>  -->
