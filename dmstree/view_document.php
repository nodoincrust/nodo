    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (docname != '' && tempname != '') {
                ...
                setTimeout(function() {
                    getDocumentValues(documentid, docname, docrevison, tenantid, departmentid, templatepath, tempname)
                }, 1000);
        ...
        function viewmorecomments(currobj) {
            ...
            $.ajax({
                ...
                data: {
                    template_id: id,
                    /* template_id contain DocumentId and Revision eg:   54507fe19fb5d3547f6526aa-1 */
                    documentname: documentname,
                    /* documentname conatin DocumentName eg:Demo */
                    type: 'getCommments'
                },
            ...
            <div class="well div-padding-top">
                <div class="row">
                    <div class="col-md-12 col-sm-12 form_title">
                        <h3 class="text-muted upload_doc_cls"><b>View Document</b></h3>
                    </div>
                </div>
                <div class="checkin" style="display: flex;justify-content: end;font-size: 16px;font-family:'Inter', Arial, sans-serif;">
                    <span class="view-doc-checkIn" style="background: #FFFCC2;color: #835101;display: inline-block;border-radius: 6px;padding: 4px 10px;font-size: 0.95em;margin-right: 8px;margin-bottom: 4px;">Status:</span>
                    <span class="doc_status" style="background: #EBF7FF;color: #0452C8;display: inline-block;border-radius: 6px;padding: 4px 10px;font-size: 0.95em;margin-right: 8px;margin-bottom: 4px;"></span>
                </div>
                <div class="div-padding">
                    <form id="viewDocumentForm" name="viewDocumentForm" method="post" class="form-horizontal  form-action" action="upload.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class='col-md-6 col-sm-6' id='date9'>
                                    <div class='input-group date' id='datetimepicker' data-date-format="DD/MM/YYYY">
                                        <input type='text' class="form-control doc_expirydate date1" style="border: 1px solid #DDE2E4" name="date" readonly />
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-sm-12 view-document-btns">
