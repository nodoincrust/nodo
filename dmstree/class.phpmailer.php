...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'Budgetbet';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Bedgetbet';
...
function smtpmailer($to, $from,$cc, $from_name, $subject, $body) {
	global $error;
	...
	$mail->Port = 465; 
	$mail->Username = 'dmstree.helpline@gmail.com'; 
	$mail->Password = 'dmstree2014';          
