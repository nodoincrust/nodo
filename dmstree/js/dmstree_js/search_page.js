        ...
        success: function (response) {
            ...
            if (response == 0) {
                ...
                for (var docindex = 0; docindex < data.length; docindex++) {
                    ...
                    if (filetype != '') {
                        documenthtml += '<div class="col-md-2"><img src="img/Document Icon Frame.svg" class="fileextension" style="height: 60px; width: 90px; object-fit: contain; border: 1px #e5e5e5;"></div>';
                    }
                    documenthtml += '<div class="col-md-9">';
                    if (docname != '') { documenthtml += '<p class="documentname"><a onclick="dynamicURL(\'' + docname + '\',\'' + revisionno + '\',\'' + templatfilename + '\',\'' + documentid + '\');" rel="facebox">' + docname + '</a><span class=docid" style="display:none">' + documentid + '</span></p>'; }
