                                        ...
                                        <div class="row comment div-margin">
                                            <div class="col-md-6">
                                                <div class="div-padding" id="add-comment1">
                                                        <a onclick="viewmorecomments(this);">View More Comments(<?php if(array_key_exists('Comments', $doc)){ echo sizeof($doc['Comments']);} else echo 0; ?>) </a>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row col-md-12" >
                                                    <div class="div-padding" id="add-tag1">
                                                        <a>View More Tags(<?php if(array_key_exists('TagList',$doc)){echo sizeof($doc['TagList']);}else {echo 0;}?>) </a>
                                                    </div>
                                                    <div class="row" style="padding:15px 5px;">
                                                        <div class="col-md-10" id="tag_diaplay" style="background-color:#f5f5f5; max-width:900px ;margin:auto">
