...
<html>
                ...
                if(docname != '' && templatelocation != '')
                    {
                        ...
                        setTimeout(function(){getDocumentValues(documentid,docname,docrevison,tenantid,departmentid)}, 1000);
                    }
   ...
   function display_imagetagging(cuurobj)
   {
      ...
      if(loc != '')
       ...
       if(taginfo != '')
           {
               var params = { 'photoloc': loc,'photoname':img_name,'tenantname':docid, 'defaulttaglist':taginfo };
           }
       else{
                var params = { 'photoloc': loc,'photoname':img_name,'tenantname':docid};
           }
                ...
                <div class="div-padding">
                     ...
                     ?>
                        <div class="form-group row">
                             <label class="col-md-12">File Name : <b><a href="download.php?filenm=<?php if($docName != ''){ echo $actualfile;} ?>"><?php echo $docName;?></a></b></label>
                        </div>
                     <?php } ?>
                     <div class="row">
                    ...
                    <div class="form-group row space">
                        ...
                        <input type="hidden" name="documentid" id="documentid" class="documentid" value="<?php if($docid != ''){echo $docid;} ?>">
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 col-sm-12">
                            <div class="radio row">
                                <label>
                                    <input type="checkbox" name="optionsRadios" id="chk_physical_loc" value="physical_loc">
                           ...
                           <div class="col-md-12 col-sm-12" id="div_pic">
                                <div class="row div-border">
                                    <div class="col-md-12">
                                      ...
                                      <?php if($docrevision != '') {?>  
                                      <div class="row"><div class="col-md-10 col-md-offset-2" id="locationcontainer" style="margin-top: 10px">
