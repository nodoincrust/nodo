...
<div class="left-container" id="sidebar">
    ...
    <div class="template-container">
        ...
        <ul class="template-menu">
            <li>
                <img src="img/file-edit-01.svg" alt="">
    ...
    <div class="master-container">
        ...
        <ul class="template-menu">
            <li>
                <img src="img/server-02.svg" alt="">
                <!-- Data Configuration -->
                <a href="data_configuration.php">Data Configuration</a>
            </li>
            <li>
                <img src="img/bell-01.svg" alt="">
    ...
    <div class="profile-container">
        <div class="profile-logo">
            <img src="img/user-profile-square.svg" alt="" onclick="toggleSidebar()"  style="cursor:pointer" >
            <span>test</span>
        </div>
    </div>
