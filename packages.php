...
<html>
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <form id="package_form" method="post" class="form-horizontal col-md-12 form-action" action="" >
                            <div class="form-group row ">
                                <label for="txt_user_mail" class="col-md-4 control-label">Package Name</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt_package_name" placeholder="Package Name" value="" name="package_name">
                                </div>
                            </div>
                            <div class="form-group row ">
                            ...
                            <div class="col-md-12">
                                <input class="btn btn-success ctrl-btn  btn-space" type="button" value="Save" onclick="save_package();">
                                <input type="reset" class="btn btn-primary btn-space" value="Reset" onclick="reset_package()">
        ...
        <?php include_once 'footer.php'?> 
            <script src="js/dmstree_js/package_page.js"></script>
    </body>
</html>