...
<head>
    ...
    <style>
        ...
        .tag_txtbox .chosen-container,
        .bouquetnm_txtbox .chosen-container {
        ...
        .predefinefiletype_txtbox .chosen-container {
            width: 100% !important;
        }
         ...
         -->
            ...
            <div class="row">
                ...
                <div class="search_doc col-md-12">
                    <div class="row">
                        <div class="col-md-12 form_title ">
                            <h2 class="hr-margin text-muted upload_doc_cls"><b>Search Document</b></h2>
                        </div>
                    </div>
                </div>
               ...
               <div class="col-md-12 form_title "><h2  class="hr-margin text-muted upload_doc_cls"><b>Search Document</b></h2></div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <label for="text" class="control-label">File Name</label>
                        </div>
                        <div class="col-md-5">
                        ...
                        <div class="col-md-2">
                            <select name="rd_databasetype" id="datatypes_select" style="height:27px;color: #666666;">
                    ...
                    <div class="row div-padding-top">
                        <div class="col-md-2 selectdocas">
                            <label for="text" class="control-label">Select Documents As:</label>
                        </div>
                        <div class="col-md-6 LatestOrAll">
                    ...
                    <input type="button" class="btn btn-success" value="Add To Archive" onclick="addSelectedToArchive();">  -->
                        <input type="button" class="save_btn_bg_cancel AddtoBouq" value="Add To Bouquet" onclick="redirecttobouquetPage();">
