...
<html>
    ...
    <body>
                ...
                <div class="row">
                    <form id="news_form" method="post" class="form-horizontal col-md-12 form-action" action="" enctype="multipart/form-data">
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="new_title" placeholder="News Title" value="" name="new_title">
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="new_description" class="col-md-2 control-label">News Description</label>
                            <div class="col-md-6">
                                <textarea class="form-control" id="new_description" placeholder="News Description" value="" name="new_description" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="new_image" class="col-md-2 control-label">News Image</label>
                            <div class="col-md-6">
                                <input type="file" class="form-control" id="new_image" name="new_image">
                            </div>
                        </div>
                        <div class="form-group row ">
                            <label for="datetimepicker1" class="col-md-2 control-label">News Valid Till</label>
                            <div class='col-md-6' id='date'>
                                <div class='input-group date' id='datetimepicker1' data-date-format="DD/MM/YYYY">
                                    <input type='text' class="form-control" id ="expiry_date" name="date" readonly />
                        ...
                        <div class="form-group row">
                            <input type="button" class="btn btn-success" value="Save" onclick="save_news();">
                            <input type="reset" class="btn btn-primary" value="Reset">
                            <input type="button" class="btn ctrl-btn" value="Cancel">
                        </div>
                    </form>
                </div>
            </div>
		...
		<script src="js/dmstree_js/create_dmstree_news_page.js"></script>
    </body>
</html>
