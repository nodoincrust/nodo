	...
	$.TextOver = function(obj, options) {
        ...
        newTextArea = function(e) {
        	...
        	position = mouseAbs(e);
                ...
                imgleft = parseInt(offset.left);
                imgtop = parseInt(offset.top);
                var textleftpos = parseInt(position[0])  - parseInt(imgleft) + parseInt(14); //parseInt(541);
                var texttoppos = parseInt(position[1]) - parseInt(imgtop) + parseInt(75); //parseInt(600);
        	textArea.css({'left':textleftpos , 'top': texttoppos});  //position[0]   position[1]
        	$(this).after(textArea);       	
