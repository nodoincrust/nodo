	...
	$.extend($.fn,{
			...
			return this.each(function() {
				...
				$(window).load(function(){
					...
					obj.parent().css("backgroundImage","url("+obj.attr('src')+")");
                                        /* Added by Mahendra to make the backgound size fixed
                                         *start here*/
                                       	obj.parent().css("background-size","400px 400px");
                                        obj.parent().css("background-repeat","no-repeat");
                                        /*Ends here*/
		...
		showDrag: function(e){
			...
			jtagdrag.css("backgroundImage","url("+obj.attr('src')+")");
                        ...
                        /* Added by Mahendra to make the backgound size fixed
                         *start here*/
                        jtagdrag.css("background-size","400px 400px");
                        jtagdrag.css("background-repeat","no-repeat");
                        /*Ends here*/
